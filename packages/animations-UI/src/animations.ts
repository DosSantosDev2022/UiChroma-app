module.exports = {
  ...
  animation: {
    ...
    // zoom
    'zoom-in': 'zoom-in 0.3s ease-in forwards',
    'zoom-out': 'zoom-out 0.3s ease-out forwards',
    // bounce
    'bounce-in': 'bounce-in 0.4s ease-in forwards',
    'bounce-out': 'bounce-out 0.4s ease-out forwards',
    // flip
    'flip-up': 'flip-up 0.6s ease-in forwards',
    'flip-down': 'flip-down 0.6s ease-out forwards',
    // slide
    'slide-up': 'slide-up 0.3s ease-in forwards',
    'slide-down': 'slide-down 0.3s ease-out forwards',
    'slide-left': 'slide-left 0.3s ease-in forwards',
    ...
    compress: 'compress 0.2s ease-in-out forwards',
