...
const pages = Object.keys(pageTranslations)
			...
			{previousPage && (
				<Link
					className={twMerge(
						...
						'hover:bg-primary hover:text-primary-foreground w-28 h-9 px-4 py-2',
					)}
					href={`/docs/${previousPage}`}
				>
					{pageTranslations[previousPage]}
				</Link>
			)}
