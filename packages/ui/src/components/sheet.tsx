...
>(({ side = 'right', className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="focus:ring-ring absolute right-4 top-4 rounded-full  p-2  data-[state=open]:bg-zinc-950 hover:bg-zinc-800 duration-200 transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none">
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={twMerge('text-xl font-semibold text-zinc-50', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description
    ref={ref}
    className={twMerge('text-base text-zinc-50', className)}
    {...props}
  />
))
