...
describe('generateTheme', () => {
  ...
  it('should include all expected color keys in light mode', () => {
    ...
    const keys: (keyof typeof light)[]  = [
      ...
      'primary', 'primary_foreground', 'primary_hover',
      'secondary', 'secondary_foreground', 'secondary_hover',
      'muted', 'muted_foreground', 'muted_hover',
      'accent', 'accent_foreground', 'accent_hover',
      'danger', 'danger_foreground', 'danger_hover',
      'warning', 'warning_foreground', 'warning_hover',
      'success', 'success_foreground', 'success_hover',
      'border', 'input', 'ring',
