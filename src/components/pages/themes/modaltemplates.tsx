		...
		<>
			<ModalRoot>
				...
				<ModalContent className='max-w-lg'>
					...
					<ModalDescription>
						Escolha um tema base para gerar seu tema baseando-se nas cores
						do Tailwind CSS:
					</ModalDescription>
					<div className='custom-scrollbar grid grid-cols-3 gap-2 border border-border p-3'>
						{themes.map((color) => (
							...
							>
								...
								<span
									className={
										'mr-1 flex h-6 w-6 shrink-0 -translate-x-1 items-center justify-center rounded-full'
									}
