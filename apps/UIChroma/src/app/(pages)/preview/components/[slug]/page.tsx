...
import { MainContainer, SectionNavigation, SectionPage, WrapperSections } from '@/components/global/containers/pageContainers'
...
export default async function ComponentDetails({
  ...
  return (
    <MainContainer >
      <SectionPage >
        <WrapperSections className='pt-0 pb-0 space-y-10'>
            <div id="Início">
